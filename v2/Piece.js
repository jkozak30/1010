class Piece {
    ...
    nOverlap(xx, yy) {
        var x = round((xx - 50)/30)*30 + 50;
        var y = round((yy - 50)/30)*30 + 50;
        var r = round((y - 50)/30);
        var c = round((x - 50)/30);
    ...
    mouseReleased() {
       this.selected = false;
       //console.log(this.x + "," + this.y);
       if (!this.placed && this.x >= 40 && this.x <= 360-this.w && this.y >= 40 && this.y <= 360-this.h && this.nOverlap(this.x, this.y)) {
           ...
           if (this.id == 0) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.score+=3;}
           if (this.id == 1) {board.colors[r+1][c+1] = this.color; board.bools[r+1][c+1] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.score+=3;}
           if (this.id == 2) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r+1][c+1] = this.color; board.bools[r+1][c+1] = true; board.score+=3;}
           if (this.id == 3) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r+1][c+1] = this.color; board.bools[r+1][c+1] = true; board.score+=3;}
           if (this.id == 4) {board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.colors[r+2][c+1] = this.color; board.bools[r+2][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r+1][c+2] = this.color; board.bools[r+1][c+2] = true; board.colors[r+2][c+2] = this.color; board.bools[r+2][c+2] = true; board.score+=5;}
           if (this.id == 5) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.score+=5;}
           if (this.id == 6) {board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.colors[r+2][c+1] = this.color; board.bools[r+2][c+1] = true; board.colors[r+2][c+2] = this.color; board.bools[r+2][c+2] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r][c] = this.color; board.bools[r][c] = true; board.score+=5;}
           if (this.id == 7) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r+1][c+2] = this.color; board.bools[r+1][c+2] = true; board.colors[r+2][c+2] = this.color; board.bools[r+2][c+2] = true; board.score+=5;}
           if (this.id == 8) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.score+=1;}
           if (this.id == 9) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.score+=2;}
           if (this.id == 10) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.score+=2;}
           if (this.id == 11) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.score+=3;}
           if (this.id == 12) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.score+=3;}
           if (this.id == 13) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.colors[r+3][c] = this.color; board.bools[r+3][c] = true; board.score+=4;}
           if (this.id == 14) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r][c+3] = this.color; board.bools[r][c+3] = true; board.score+=4;}
           if (this.id == 15) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.colors[r+3][c] = this.color; board.bools[r+3][c] = true; board.colors[r+4][c] = this.color; board.bools[r+4][c] = true; board.score+=5;}
           if (this.id == 16) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r][c+3] = this.color; board.bools[r][c+3] = true; board.colors[r][c+4] = this.color; board.bools[r][c+4] = true; board.score+=5;}
           if (this.id == 17) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r+1][c+1] = this.color; board.bools[r+1][c+1] = true; board.score+=4;}
           if (this.id == 18) {board.colors[r][c] = this.color; board.bools[r][c] = true; board.colors[r+1][c] = this.color; board.bools[r+1][c] = true; board.colors[r][c+1] = this.color; board.bools[r][c+1] = true; board.colors[r+1][c+1] = this.color; board.bools[r+1][c+1] = true; board.colors[r+2][c] = this.color; board.bools[r+2][c] = true; board.colors[r+2][c+1] = this.color; board.bools[r+2][c+1] = true; board.colors[r][c+2] = this.color; board.bools[r][c+2] = true; board.colors[r+1][c+2] = this.color; board.bools[r+1][c+2] = true; board.colors[r+2][c+2] = this.color; board.bools[r+2][c+2] = true; board.score+=9;}
           this.placed = true;
       } else {
           this.x = this.spawnX;
           this.y = this.spawnY;
    ...
    canPlace() {
        for (var j=0; j<=10 - this.h/30; j++) {
            for (var i=0; i<=10 - this.w/30; i++) {
                if (this.nOverlap(i*30+50, j*30+50)) return true;
            }
        }
        return false;
    }
